         ...
         realms => {
		   ...
		   user_model => 'TestAppDB::User',
                ...
                credential => {
                   ...
                   api_uri => URI::file->new_abs('./t/dat/app_user.json'),
                   providers => {
...
# load a page
$mech->get_ok('/index', 'full authentication for APP user');
$mech->content_like(qr/App User/, 'APP user info imbedded in page');

# load another page
$mech->get_ok('/home', 'reusing the APP user info for the next page');

# logout
$mech->get_ok('/logout', 'APP log out');

# load home again
$mech->get_ok('/home', 'APP logging in again');
